...
3. Si el proyecto tiene un Dev Container, VS Code mostrará un mensaje indicando “Reopen in Container”. Haz clic en **Reopen in Container**.
4. Espera a que el Dev Container se construya e inicie. Esto puede tardar unos minutos la primera vez.
5. Una vez iniciado, el terminal de VS Code estará dentro del Dev Container, listo para ejecutar comandos Maven y Java.
